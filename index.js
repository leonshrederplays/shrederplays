...
/*bot.on('guildMemberAdd', member => {
  ...
  var role = member.guild.roles.find('id', '380341276832301056'); //THIS LOOKS FOR THE ROLE IN THE SERVER(GUILD), IT SEARCHES BY NAME, MEANING YOU CAN CHANGE 'USER' TO THE ROLE YOU WANT!
